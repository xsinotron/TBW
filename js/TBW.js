(function () {
    ...
    define('TBW',["jquery"], function () {
        ...
        this.init = function (params) {
            ...
            TBW.constrained = params.constrained || false;
        ...
        function showZone (elt) {
            ...
            var zone = parseInt(elt.attr("data-zone"), 10),
                x    = parseInt(elt.parents(".grid-case").attr("data-x"), 10),
                y    = parseInt(elt.parents(".grid-case").attr("data-y"), 10);
